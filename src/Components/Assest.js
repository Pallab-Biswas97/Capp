...
const Asset=()=>{
    return(
        ...
        <div className="container d-flex">
            ...
            <div className="co"><div className="content">Blogs</div><img className="img_arrow" src={Arrow}/></div></div></div>

            <div className="asset"><div className="animation_bg"></div><div className="d-flex"><div><img className="img_asset" src={Link}/></div>
            <div className="co"><div className="content">Links</div><img className="img_arrow" src={Arrow}/></div></div></div>

            <div className="asset"><div className="animation_bg"></div><div className="d-flex"><div><img className="img_asset" src={Labs}/></div>
            <div className="co"><div className="content">Labs</div><img className="img_arrow" src={Arrow}/></div></div></div>
             
            <div className="asset"><div className="animation_bg"></div><div className="d-flex"><div><img className="img_asset" src={Event}/></div>
            <div className="co"><div className="content">Events</div><img className="img_arrow" src={Arrow}/></div></div></div>
            
            <div className="asset"><div className="animation_bg"></div><div className="d-flex"><div><img className="img_asset" src={Training}/></div>
            <div className="co"><div className="content">Trainings</div><img className="img_arrow" src={Arrow}/></div></div></div>
